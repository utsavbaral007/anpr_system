...
additional_layer = layers.GlobalAveragePooling2D()(additional_layer)
...
test_dataset = ImageDataGenerator(rescale=1/255).flow_from_directory('digits_and_numbers_dataset/test/', batch_size = 1, class_mode = 'categorical', target_size=(32, 32))
